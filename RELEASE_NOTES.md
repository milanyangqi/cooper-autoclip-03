...
1. 双击 DMG，将 `Cooper AutoClip 03` 拖入「应用程序」。
...
Cooper AutoClip 03是基于AI的智能视频切片工具，支持自动识别精彩片段并生成合集。
...
- 阅读 [常见问题](docs/FAQ.md)
- 提交 [GitHub Issue](https://github.com/milanyangqi/cooper-autoclip-03/issues)
...
**下载地址**: [GitHub Releases](https://github.com/milanyangqi/cooper-autoclip-03/releases)

**项目主页**: [GitHub Repository](https://github.com/milanyangqi/cooper-autoclip-03)

**问题反馈**: [GitHub Issues](https://github.com/milanyangqi/cooper-autoclip-03/issues)
